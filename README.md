...
```
Nama  : Azzah Aulia Syarif 
Kelas : VB
NIM   :105841105022
```
## 1. Pendahuluan 
Project Lab Backend ini adalah implementasi sistem BackEnd menggunakan framework NestJS, yang dirancang dengan berbagai fitur seperti autentikasi, middleware, guard, file upload dan getter, WebSocket, serta integrasi database menggunakan Prisma.

## 2. STRUKTUR PROYEK
Berikut ini adalah struktur proyek **BackEnd-NestJS**:
```
📦dist
 ┣ 📂chat
 ┃ ┣ 📂dto
 ┃ ┃ ┣ 📜create-chat.dto.d.ts
 ┃ ┃ ┣ 📜create-chat.dto.js
 ┃ ┃ ┣ 📜create-chat.dto.js.map
 ┃ ┃ ┣ 📜update-chat.dto.d.ts
 ┃ ┃ ┣ 📜update-chat.dto.js
 ┃ ┃ ┗ 📜update-chat.dto.js.map
 ┃ ┣ 📂entities
 ┃ ┃ ┣ 📜chat.entity.d.ts
 ┃ ┃ ┣ 📜chat.entity.js
 ┃ ┃ ┗ 📜chat.entity.js.map
 ...
 ┃ ┗ 📜chat.service.js.map
 ┣ 📂dto
 ┃ ┣ 📜create-mahasiswa.dto.d.ts
 ┃ ┣ 📜create-mahasiswa.dto.js
 ┃ ┣ 📜create-mahasiswa.dto.js.map
 ┃ ┣ 📜register-user.dto.d.ts
 ┃ ┣ 📜register-user.dto.js
 ┃ ┣ 📜register-user.dto.js.map
 ┃ ┣ 📜update-mahasiswa.dto.d.ts
 ┃ ┣ 📜update-mahasiswa.dto.js
 ┃ ┗ 📜update-mahasiswa.dto.js.map
 ┣ 📂entity
 ┃ ┣ 📜user.entity.d.ts
 ┃ ┣ 📜user.entity.js
 ┃ ┗ 📜user.entity.js.map
 ...
 ┃ ┣ 📜profile.service.d.ts
 ┃ ┣ 📜profile.service.js
 ┃ ┗ 📜profile.service.js.map
 ┣ 📜app.controller.d.ts
 ┣ 📜app.controller.js
...
|`JWT (JSON Web Token)`| Library untuk pembuatan tokenisasi untuk validasi user. 
---
...
- `foto_profile`: Foto profil mahasiswa 
...
- `create_at`: Waktu pembuatan akun user.
#### d. **Enum `UserRole`**
...
2. **Install dependencies untuk BackEnd**
   ...
   npx prisma generate  
   ```   
3. **Install dependencies untuk Aplikasi Chat**
   ```sh
   cd webSocket
   cd chat-client
   npm install 
...
4. **Menjalankan server BackEnd**
   ...
   npm run start:dev
   ```
5. **Menjalankan server Aplikasi Chat**
   ```sh
   npm run dev 
   ```
6. **Akses API BackEnd:**
